...
function CardOfProperty({property}) {
  ...
  return (<>
      ...
      <Card.Body>
          <Card.Title>
            <div style={{padding:'0.5rem', backgroundColor:'black', color: 'white', display:'inline-block', width:'100%', fontFamily:'fantasy', textAlign:'center'}}>
            {property.price}₪
            </div></Card.Title>
          <Card.Text>
            ...
            <div style={{display:'flex', flexDirection:"column" ,gap:'1rem', direction:'rtl', textAlign:'center'}}>
              ...
              <div style={{fontSize:'18px'}}>
                דירת {property.rooms} חדרים ב{property.address}
              </div>
